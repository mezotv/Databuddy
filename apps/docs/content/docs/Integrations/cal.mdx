...
By default, Databuddy only accepts requests from your website's registered domain. To track analytics from Cal.com booking pages, you need to add Cal.com to your allowed origins.

**Go to:** Open [Websites](https://app.databuddy.cc/websites), select your site, then go to **Settings → Security**.
...
- In Databuddy, you can use the [dashboard](/docs/dashboard) to measure drop-off, set up goals, and optimize conversions.
...
<Cards>
  ...
  <Card title="Google Tag Manager" href="/docs/Integrations/gtm">
    Manage Databuddy alongside other marketing tags.
  </Card>
</Cards>
