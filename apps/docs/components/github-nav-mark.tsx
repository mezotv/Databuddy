export const githubRepoUrl = "https://github.com/databuddy-analytics/Databuddy";

const githubMarkPathD =
...
export function GithubNavMark({ className }: GithubNavMarkProps) {
	return (
		...
		>
			<title>GitHub</title>
			<path d={githubMarkPathD} fill="currentColor" />
		</svg>
	);
}
